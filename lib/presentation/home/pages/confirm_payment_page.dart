                        ...
                        BlocBuilder<CheckoutBloc, CheckoutState>(
                          builder: (context, state) {
                            return state.maybeWhen(
                              ...
                              loaded: (products, discout, tax, serviceCharge) {
                                if (products.isEmpty) {
                                  return const Center(
                                    child: Text('No Items'),
                                  );
                          ...
                          children: [
                            ...
                            BlocBuilder<CheckoutBloc, CheckoutState>(
                              builder: (context, state) {
                                ...
                                return Text(
                                  serviceCharge.toInt().currencyFormatRp,
                                  style: const TextStyle(
                                    color: AppColors.primary,
                                    fontWeight: FontWeight.w600,
                                  ),
                          ...
                          children: [
                            ...
                            BlocBuilder<CheckoutBloc, CheckoutState>(
                              builder: (context, state) {
                                ...
                                final subTotal =
                                    (price - (discount / 100 * price).toInt());
                                final tax = (subTotal * 0.11).toInt();
                                final serviceCharge = (subTotal * 0.05).toInt();
                                ...
                                BlocBuilder<CheckoutBloc, CheckoutState>(
                                  builder: (context, state) {
                                    ...
                                    final subTotal = price -
                                        ((discount / 100 * price).toInt());
                                    final finalTax = (subTotal * 0.11).toInt();
                                    final serviceCharge =
                                        (subTotal * 0.05).toInt();
                                    final finalDiscount =
                                        (discount / 100 * price).toInt();
                                    final totalPrice =
                                        subTotal + finalTax + serviceCharge;
