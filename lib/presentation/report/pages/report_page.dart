                ...
                child:
                  ...
                  builder: (context, state) {
                    final totalPrice = state.maybeMap(
                      orElse: () => 0,
                      loaded: (value) => value.transactionReport.fold(
                          0,
                    ...
                    final serviceCharge = state.maybeMap(
                      orElse: () => 0,
                      loaded: (value) => value.transactionReport.fold(
                          0,
                          (previousValue, element) =>
                              previousValue + element.serviceCharge),
                    );

                    final finalDiscount = totalPrice - subTotal;
                    ...
                    return state.maybeWhen(
                      ...
                      loaded: (transactionReport) => Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Center(
                            child: Text(
