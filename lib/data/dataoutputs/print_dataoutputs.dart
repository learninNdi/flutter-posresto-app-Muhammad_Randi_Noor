...
class PrintDataoutputs {
  ...
  Future<List<int>> printOrder(
    ...
    bytes += generator.text('FOCUS RESTO',
    ...
    bytes += generator.text('Jalan Encep Kartawiria No. 126',
        styles: const PosStyles(bold: true, align: PosAlign.center));
    bytes += generator.text('Kota Cimahi',
        styles: const PosStyles(bold: true, align: PosAlign.center));
    ...
    bytes += generator.row([
      ...
      PosColumn(
        // text: tax.ceil().currencyFormatRp,
        text: serviceCharge.currencyFormatRp,
        width: 6,
        styles: const PosStyles(align: PosAlign.right),
      ),
    ]);
    ...
    bytes += generator.row([
      ...
      PosColumn(
        // text: total.ceil().currencyFormatRp,
        text: (paymentAmount - totalPrice).currencyFormatRp,
        width: 6,
        styles: const PosStyles(align: PosAlign.right),
      ),
    ]);
